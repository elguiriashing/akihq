...
test.before(async()=>{
  ...
  await db.exec(`
    ...
    create table public.crm_support_tickets(id uuid primary key,workspace_id text,contact_id uuid,status text,updated_at timestamptz,subject text,number bigint,created_at timestamptz);
